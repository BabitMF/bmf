...
def preload_model_llava(args, model_dir, load_model_on_cpu):
    ...
    model = LlavaQwenForCausalLM.from_pretrained(model_dir, low_cpu_mem_usage=True, attn_implementation='flash_attention_2', **kwargs)
    return model
