...
namespace bmf {
    ...
    public:
         ...
         * @param [in] is_path When set to true, 'graph_config' means a path to json file containing graph config.
         *      This param is set to False by default.
         * @param [in] need_merge When set to true, BMF will preprocess graph to merge ffmpeg_filter nodes into groups if possible.
         *      A merge operation can make graph running faster, but may also introduce some stability issue.
         *      This param is set to true by default.
         */
        BMF_FUNC_VIS BMFGraph(std::string const &graph_config, bool is_path = false, bool need_merge = true);
         ...
         * @return
         */
        BMF_FUNC_VIS int add_input_stream_packet(std::string const &stream_name, bmf_sdk::Packet &packet, bool block = false);
         ...
         * @return
         */
        BMF_FUNC_VIS bmf_sdk::Packet poll_output_stream_packet(std::string const &stream_name, bool block = true);
    ...
    public:
         ...
         */
        BMF_FUNC_VIS BMFModule(std::string const &module_name, std::string const &option, std::string const &module_type = "",
                  std::string const &module_path = "", std::string const &module_entry = "");
    ...
    public:
         ...
         * @param [in] callback
         */
        BMF_FUNC_VIS BMFCallback(std::function<bmf_sdk::CBytes(bmf_sdk::CBytes)> callback);
