...
//////////////// bmf::BMFGraph ////////////////
BMF_API bmf_BMFGraph bmf_make_graph(char const *graph_json, bool is_path, bool need_merge);
...
BMF_API int
bmf_graph_add_input_stream_packet(bmf_BMFGraph graph, char const *stream_name,
				  bmf_Packet packet, bool block);
BMF_API bmf_Packet
bmf_graph_poll_output_stream_packet(bmf_BMFGraph graph, char const *stream_name);
BMF_API int bmf_graph_update(bmf_BMFGraph graph, char const *config, bool is_path);
BMF_API int bmf_graph_force_close(bmf_BMFGraph graph);
BMF_API char* bmf_graph_status(bmf_BMFGraph graph);


///////////////// bmf::BMFModule ////////////////
BMF_API bmf_BMFModule
bmf_make_module(char const *module_name, char const *option,
