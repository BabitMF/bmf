...
// version string
#define HMP_VERSION_STR() HMP_STR(HMP_VERSION_MAJOR) "." HMP_STR(HMP_VERSION_MINOR) "." HMP_STR(HMP_VERSION_PATCH)
...
template<typename F>
impl::Defer<F> defer(F && f) { return impl::Defer<F>(std::move(f)); }
