...
struct AudioChannelLayout
{
    ...
    enum Layout{
        ...
        kLAYOUT_6POINT0_FRONT     = (kLAYOUT_2_2|kFRONT_LEFT_OF_CENTER|kFRONT_RIGHT_OF_CENTER),
        ...
        kLAYOUT_7POINT0_FRONT     = (kLAYOUT_5POINT0|kFRONT_LEFT_OF_CENTER|kFRONT_RIGHT_OF_CENTER),
        kLAYOUT_7POINT1           = (kLAYOUT_5POINT1|kBACK_LEFT|kBACK_RIGHT),
        kLAYOUT_7POINT1_WIDE      = (kLAYOUT_5POINT1|kFRONT_LEFT_OF_CENTER|kFRONT_RIGHT_OF_CENTER),
        kLAYOUT_7POINT1_WIDE_BACK = (kLAYOUT_5POINT1_BACK|kFRONT_LEFT_OF_CENTER|kFRONT_RIGHT_OF_CENTER),
        kLAYOUT_OCTAGONAL         = (kLAYOUT_5POINT0|kBACK_LEFT|kBACK_CENTER|kBACK_RIGHT),
        kLAYOUT_HEXADECAGONAL     = (kLAYOUT_OCTAGONAL|kWIDE_LEFT|kWIDE_RIGHT|kTOP_BACK_LEFT|kTOP_BACK_RIGHT|kTOP_BACK_CENTER|kTOP_FRONT_CENTER|kTOP_FRONT_LEFT|kTOP_FRONT_RIGHT),
        kLAYOUT_STEREO_DOWNMIX    = (kSTEREO_LEFT|kSTEREO_RIGHT)
    };
};


class BMF_API AudioFrame : public OpaqueDataSet,
		                   public SequenceData
{
    struct Private;
