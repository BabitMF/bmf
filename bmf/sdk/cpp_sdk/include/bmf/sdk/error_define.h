...
enum {
    ...
    BMF_BadDataPtr = -12,  /**/
    BMF_BadStep = -13,  /**< image step is wrong, this may happen for a non-continuous matrix */
    BMF_BadModelOrChSeq = -14,  /**/
    BMF_BadNumChannels = -15,  /**< bad number of channels, for example, some functions accept only single channel matrices */
    BMF_BadNumChannel1U = -16,  /**/
    BMF_BadDepth = -17,  /**< input image depth is not supported by the function */
    ...
    BMF_StsUnmatchedFormats = -205, /**< formats of input/output arrays differ */
    ...
    BMF_StsUnmatchedSizes = -209, /**< sizes of input/output structures do not match */
    BMF_StsUnsupportedFormat = -210, /**< the data format/type is not supported by the function*/
    BMF_StsOutOfRange = -211, /**< some of parameters are out of range */
    BMF_StsParseError = -212, /**< invalid syntax/structure of the parsed file */
    BMF_StsNotImplemented = -213, /**< the requested function/feature is not implemented */
