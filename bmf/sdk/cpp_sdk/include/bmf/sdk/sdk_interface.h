 ...
 *  1. const static int OpaqueDataInfo::key = PrivateKey::xxx; //specify the key assicated to type T, key is allocated in PrivateKey
...
public:
    ...
    /**
     * @brief Retrieve readonly private data which attached by private_attach or private_merge
     * 
     * @tparam T 
     * @return const T* 
     */
