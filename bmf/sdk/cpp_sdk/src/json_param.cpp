...
JsonParam::JsonParam(nlohmann::json json_value) { json_value_ = json_value; }
...
void JsonParam::set_value(nlohmann::json &value) { json_value_ = value; }
