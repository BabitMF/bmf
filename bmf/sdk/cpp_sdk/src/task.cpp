...
BEGIN_BMF_SDK_NS
Task::Task(int node_id, std::vector<int> input_stream_id_list,
...
Task::Task(Task &&rhs) : Task() { swap(*this, rhs); }
...
void Task::init(int node_id, std::vector<int> input_stream_id_list,
                std::vector<int> output_stream_id_list) {
    node_id_ = node_id;
    timestamp_ = 0;
...
int64_t Task::timestamp() const { return timestamp_; }

void Task::set_timestamp(int64_t t) { timestamp_ = t; }
...
PacketQueueMap &Task::get_inputs() { return inputs_queue_; }

PacketQueueMap &Task::get_outputs() { return outputs_queue_; }

int Task::get_node() { return node_id_; }
