...
class flip_and_scale(SubGraph):
    ...
    def create_graph(self, option=None):
        ...
        v1 = v1.scale(500, 400).vflip().trim(start=0,
                                             end=5).setpts('PTS-STARTPTS')
        ...
        concat_video = bmf.module([v1, v2], 'simple_video_concat',
                                  {"dump_graph": 1})
        concat_audio = bmf.module([a1, a2], 'simple_audio_concat',
                                  {"dump_graph": 1})
