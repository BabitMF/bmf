...
def test_3_concat():
    ...
    # create graph
    my_graph = bmf.graph({"dump_graph": 1, "graph_name": "3_concat"})
    ...
    concat_video = (bmf.concat(video1, video2, video3, n=3, v=1, a=0))
...
def test_triangle_concat():
    ...
    # create graph
    my_graph = bmf.graph({"dump_graph": 1, "graph_name": "triangle_concat"})
...
def test_last_pic():
    ...
    v1 = v_list[0]
    v2 = v_list[1]
    v1 = v1.module("get_last_pic_from_video", option={
        'num': 1
    }).loop(loop=-1, size=2, start=0).trim(start=0, duration=30)
    v1 = v1.pass_through()
    # v2 = v2.pass_through()
...
def test_several_long_bmf():
    ...
    # create graph
    my_graph = bmf.graph({"dump_graph": 1, "graph_name": "several_long_bmf"})
...
def test_decoder_encoder():
    ...
    # create graph
    my_graph = bmf.graph({"dump_graph": 1, "graph_name": "decoder_encoder"})
...
def test_5_concat():
    ...
    concat_video1 = (bmf.concat(video1, video2, n=2, v=0, a=1))
    concat_video2 = (bmf.concat(video3, video4, n=2, v=0, a=1))
    concat_video = (bmf.concat(concat_video1,
                               concat_video2,
                               video5,
                               n=3,
                               v=0,
