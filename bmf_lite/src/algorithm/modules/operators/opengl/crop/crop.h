 ...
 */
#ifndef _BMF_ALGORITHM_MODULES_OPS_OPENGL_CROP_H_
#define _BMF_ALGORITHM_MODULES_OPS_OPENGL_CROP_H_
#include <string>
...
class Crop {
  public:
     ...
     * @return error code
     */
    int run(GLuint in_tex, GLuint out_tex, int in_width, int in_height,
