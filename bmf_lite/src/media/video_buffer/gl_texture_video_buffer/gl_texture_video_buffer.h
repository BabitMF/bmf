...
#ifndef _BMF_GLTEXTURE_VIDEO_BUFFER_H_
#define _BMF_GLTEXTURE_VIDEO_BUFFER_H_
...
class GlTextureVideoBuffer : public VideoBuffer {
  public:
    GlTextureVideoBuffer(int texture_id, int width, int height,
    ...
    void *data() { return (void *)texture_id_; };
