...
#ifndef _BMF_GLTEXTURE_VIDEO_BUFFER_ALLOCATOR_H_
#define _BMF_GLTEXTURE_VIDEO_BUFFER_ALLOCATOR_H_

#include "media/video_buffer/video_buffer_allocator.h"

namespace bmf_lite {

class GlTextureVideoBufferAllocator : public VideoBufferAllocator {
  public:
    GlTextureVideoBufferAllocator();
    ~GlTextureVideoBufferAllocator();
