...
#ifndef _BMF_CPU_MEMORY_VIDEO_BUFFER_ALLOCATOR_H_
#define _BMF_CPU_MEMORY_VIDEO_BUFFER_ALLOCATOR_H_

#include "media/video_buffer/video_buffer_allocator.h"

namespace bmf_lite {

class CpuMemoryVideoBufferAllocator : public VideoBufferAllocator {
  public:
    CpuMemoryVideoBufferAllocator();
    ~CpuMemoryVideoBufferAllocator();
