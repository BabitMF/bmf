...
#ifndef _BMFLITE_METAL_TEXTURE_VIDEOBUFFER_ALLOCATOR_H_
#define _BMFLITE_METAL_TEXTURE_VIDEOBUFFER_ALLOCATOR_H_

#include "media/video_buffer/video_buffer_allocator.h"

namespace bmf_lite {
class MetalTextureVideoBufferAllocator : public VideoBufferAllocator {
  public:
...
#endif // _BMFLITE_METAL_TEXTURE_VIDEOBUFFER_ALLOCATOR_H_